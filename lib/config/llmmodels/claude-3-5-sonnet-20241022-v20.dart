...
const ChatModel anthropicClaude35Sonnet = ChatModel(
 // The real model id
 ...
 contextWindow: 200000, // Defaulting to a common large context window

 // The maximum token output (from max_output_tokens)
 maxTokenOutput: 8192, // Defaulting to a common output token limit
