...
const ChatModel cohereCommandTextV14 = ChatModel(
 // The real model id
 id: "cohere.command-text-v14",

 // The display name if desired (optional)
 displayName: "command-text-v14",

 // How much the model costs in USD
 cost: ChatModelCost(input: 1.5, output: 2.0),
 ...
 contextWindow: 4096, // Defaulting to a common value as max_input_tokens is not provided

 // The maximum token output (from max_output_tokens)
 maxTokenOutput: 4096, // Defaulting to a common value as max_output_tokens is not provided
